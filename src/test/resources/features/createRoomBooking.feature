Feature: Create Room Booking API
  ...
  Scenario Outline: Create booking with unusual input values
    ...
    Examples:
      | inputType | data                                                                                                    | status |
      | firstname | 9087678                                                                                                 | 400    |
      | lastname  | 456734                                                                                                  | 400    |
      | firstname | looohgbjc jksgbc jdsj oooooohdjcbgtu ujhh hgshgdtgsg yagsgdb xhgsgis igGhBChjsgd ggcSGdk ngest textasffa| 400    |
      | firstname | %^%*($%$&                                                                                               | 400    |
      | lastname  | hgshgdtgsg yagsgdb xhgsgis igGhBChjsgd ggcSGdk jkhkk uyuyuh jh  usDuywddgg JDG cbsgdgcbsdg usDGUG cbsg t| 400    |
      | lastname  | _)(*&^%*                                                                                                | 400    |
      | phone     | qwerty                                                                                                  | 400    |
      | email     | ^%&%&%&%898@test.com                                                                                    | 400    |  
