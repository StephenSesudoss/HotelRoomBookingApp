Feature: Create Booking API
  ...
  Scenario Outline: Create booking with valid data
    When User creates booking with "<firstname>" "<lastname>" "<price>" "<check In>" "<check Out>" "<depositpaid>" "<email>" "<phone>"
    Then Response status should be 200
    And booking created successfully by showing bookingId
    And Response should match booking schema
    Examples:
| firstname | lastname  | price | check In   | check Out  | depositpaid | email               | phone        |
| Sarah     | Johnson   | 220   | 12-04-2026 | 16-04-2026 | true        | sarahj@gmail.com    | 09999706050  |
| Daniel    | Carter    | 300   | 15-05-2026 | 20-05-2026 | false       | Dcarter@hotmail.com | 08978906050  |
